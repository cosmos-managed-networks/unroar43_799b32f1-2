...
#
# Examples:
# CHAIN_ID="local-1" HOME_DIR="~/.unroar43" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="local-2" HOME_DIR="~/.unroar43" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
export HOME_DIR=$(eval echo "${HOME_DIR:-"~/.unroar43"}")
export BINARY=${BINARY:-unroar43d}
export DENOM=${DENOM:-unroar43}
...
from_scratch () {
  ...
  # unroar431efd63aw40lxf3n4mhf7dzhjkr453axur2ya6uz
  ...
  # unroar431hj5fveer5cjtn4wd6wstzugjfdxzl0xpksw74t
